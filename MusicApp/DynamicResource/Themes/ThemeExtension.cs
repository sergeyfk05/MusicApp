...
namespace MusicApp.DynamicResource.Themes
{
    ...
    {
        private Type typeManager = typeof(ThemeManager);
        ...
        public ThemeExtension(string key)
        {
            Key = key;
        }
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            if (!string.IsNullOrEmpty(Key))
            {
                ...
                {
                    var binding = new Binding(nameof(KeyDynamicResourceListener<ThemeManager>.Value))
                    {
                        Source = listener,
                ...
                {
                    targetBinding.Path = new PropertyPath(nameof(KeyDynamicResourceListener<ThemeManager>.Value));
